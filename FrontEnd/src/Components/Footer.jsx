...
function Footer() {
  return (
    <footer className="bg-gray-600 text-gray-200 pt-12 pb-6 mt-0">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-gray-700 pb-10">
        ...
        <div className="mr-12">
          ...
          <p className=" leading-relaxed">
            Discover your dream home, explore the perfect property, and turn your real-estate dreams into reality with ease, confidence, and peace of mind.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3">
              ...
              <span>Kota 325003, Rajasthan, India</span>
            </li>
            <li className="flex items-center gap-3">
              <Phone size={18} className="text-blue-500" />
              <span>+91 7631994088</span>
            </li>
            <li className="flex items-center gap-3">
              <Mail size={18} className="text-blue-500" />
              <span>2024kuad3015@iiitkota.ac.in</span>
            </li>
          </ul>
           {/* Social Icons */}
          <div className="flex gap-4 mt-5">
            <a
              href="#"
              className="p-2 bg-gray-800 hover:bg-blue-600 rounded-xl transition-all duration-300"
            >
              <Instagram className="text-white" size={30} />
            </a>
            <a
              href="https://github.com/ABHI20032004/Real-Estate"
              className="p-2 bg-gray-800 hover:bg-pink-500 rounded-xl transition-all duration-300"
            >
              <Github className="text-white" size={30} />
            </a>
            <a
              href="https://www.linkedin.com/in/abhishek-raj3015"
              className="p-2 bg-gray-800 hover:bg-blue-500 rounded-xl transition-all duration-300"
            >
